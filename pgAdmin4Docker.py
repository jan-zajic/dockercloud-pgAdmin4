...
if __name__ == '__main__':
    ...
    try:
        fixApp = FixScriptName(app)
        run_simple(config.DEFAULT_SERVER, server_port, fixApp, use_reloader=((not PGADMIN_RUNTIME) and app.debug), threaded=config.THREADED_MODE)
    except IOError:
